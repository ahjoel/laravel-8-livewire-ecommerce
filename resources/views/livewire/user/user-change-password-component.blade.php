                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="changePassword">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Current Password" class="form-control input-md" name="password" wire:model="password">
                                    @error('password')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Current Password" class="form-control input-md" name="password_confirmation" wire:model="password_confirmation">
