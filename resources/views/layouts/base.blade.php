                    ...
                    <div class="wrap-icon right-section">
                        ...
                        <div class="wrap-icon-section minicart">
                            <a href="#" class="link-direction">
                                ...
                                <div class="left-info">
                                    @if(Cart::count() > 0)
                                        <span class="index">{{Cart::count(false)}} items</span>
                                    @endif
...
<script src="https://cdn.tiny.cloud/1/yzixvs5b5wloxzvh6q8ux83l6nb5v1dbt8o6xe4nimo2qzs0/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
@livewireScripts
